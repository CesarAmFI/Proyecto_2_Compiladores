...
private:
    ...
    // Globales (atributos heredados del Parser)
    int parser_type;
    std::string parser_id;
    std::vector<Expression> parser_list;
    Expression parser_expression;
    Expression parser_false_label;
    Expression parser_next_label;
...
public:
    ...
    // Getters de globales
    int get_parser_type();
    std::string get_parser_id();
    std::vector<Expression> get_parser_list();
    Expression get_parser_expression();
    Expression get_parser_false_label();
    Expression get_parser_next_label();

    // Setters de globales
    void set_parser_type(int type);
    void set_parser_id(std::string id);
    void set_parser_list(std::vector<Expression> list);
    void set_parser_expression(Expression expression);
    void set_parser_false_label(Expression false_label);
    void set_parser_next_label(Expression next_label); 
